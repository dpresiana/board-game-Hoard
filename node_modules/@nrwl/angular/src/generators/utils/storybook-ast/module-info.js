...
function getClassDeclaration(className, file) {
    ...
    const classDeclaration = (0, typescript_1.findNodes)(file, tsModule.SyntaxKind.ClassDeclaration).find((classDeclaration) => classDeclaration
        .getChildren()
        .find((node) => node.kind === tsModule.SyntaxKind.Identifier &&
...
function getVariableDeclaration(variableName, file) {
    ...
    const variableDeclaration = (0, typescript_1.findNodes)(file, tsModule.SyntaxKind.VariableDeclaration).find((variableDeclaration) => variableDeclaration
        .getChildren()
        .find((node) => node.kind === tsModule.SyntaxKind.Identifier &&
